...
@WebServlet("/dep")
public class Deposite_Servlet extends HttpServlet {
	  int amt=0;
	  int pin=0;
			...
			throws ServletException,IOException
	{
		...
		if(hs==null)
		{
			...
			pw.println("<center><h2>SESSION EXPIRED PLS LOGIN AGAIN..</h2></center>"+"<br>");
		...
		else
		{
		     int c=0;
				try {
					 amt=Integer.parseInt(req.getParameter("damt"));
					 pin=Integer.parseInt(req.getParameter("dpin"));
					...
					catch(Exception e)
					{
						...
						RequestDispatcher rd=req.getRequestDispatcher("dep.html");
						rd.include(req, res);
						e.printStackTrace();
				...
				{
					System.out.println("Commons in dep: "+ViewBalance_Servlet.common);
				}
			...
			{
				 pw.println("<center><h2>YOU CAN DEPOSIT MINIMUN 100 AT A TIME..</h2></center>"+"<br>");
			...
			{
				 pw.println("<center><h2>YOU CAN DEPOSIT MAXIMUM 100000 AT A TIME..</h2></center>"+"<br>");
			...
			{
				String result= new DepositDAO().Deposit(req);
				...
				if(result!=null)
				{
					...
					ViewBalance_Servlet.common=0;
					  ...
					  System.out.println("Commons in dep "+ViewBalance_Servlet.common);
					 pw.println("<center><h2>"+result+"</h2></center>"+"<br>");
